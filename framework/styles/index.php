...
class Loveus_Style {
	...
	public function enqueue_style() {
		...
		wp_enqueue_style( 'scrollbar', LOVEUS_CSS_URL . 'scrollbar.css', false, '1' );
		wp_enqueue_style( 'hover', LOVEUS_CSS_URL . 'hover.css', false, '1' );
		wp_enqueue_style( 'jquery-touchspin', LOVEUS_CSS_URL . 'jquery.touchspin.css', false, '1' );
